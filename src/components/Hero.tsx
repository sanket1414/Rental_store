            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-gray-900 dark:text-white leading-[1.1] mb-8 transition-colors duration-300">
                            Elegance is not <br />
                            <span className="text-[#D4AF37] italic">rented</span>, <br />
                            it is worn.
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href="#collections" className="bg-[#D4AF37] px-8 py-4 rounded-full font-bold text-sm uppercase tracking-wider hover:bg-white transition-all shadow-lg shadow-[#D4AF37]/25 text-black hover:text-black" style={{ color: 'black' }}>
                                View Collection
                            </Link>
                    ...
                    <div className="relative h-[600px] hidden lg:block">
                        ...
                        >
                            <img src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=2583&auto=format&fit=crop" className="w-full h-full object-cover" alt="Bridal Lehenga" />
                        </motion.div>
                        ...
                        >
                            <img src="https://upload.wikimedia.org/wikipedia/commons/4/47/Ranveer_Singh_promoting_Bajirao_Mastani.jpg" className="w-full h-full object-cover" alt="Royal Groom Sherwani" />
                        </motion.div>
                        ...
                        >
                            <img src="https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?q=80&w=2670&auto=format&fit=crop" className="w-full h-full object-cover" alt="Jewellery" />
                        </motion.div>
